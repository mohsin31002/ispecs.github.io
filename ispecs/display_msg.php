...
<?php
 if (!isset($_SESSION['email'])) 
    ...
    {
        echo "<div style='border:3px solid #1abc9c;font-weight:bold; font-size:20px; width:600px;padding:14px;margin-left:380px;'>";
        echo "Notification "; 
        echo "</div>";

        echo "<div style='border:3px solid #1abc9c;font-weight:bold; font-size:16px; width:600px;padding:30px;margin-left:380px;'>";
        ...
        echo "<div style='color:red'>"; echo $_SESSION['email']; echo"</div>";
