...
<!------------------------------------------- Center Area ----------------------------------------------------->
                ...
                <div class="col-md-3 col-sm-6" style="margin-bottom:  90px; margin-top: 20px;">
                    <div class="single-shop-product">
                        <div class="product-upper">
                            <a href="rayban.php"><img src="img/rayban.png"  style="height: 170px; width: 200"></a>
                            <h2 style="margin-left: 70px">Rayban</h2>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3 col-sm-6" style="margin-bottom:  90px; margin-top: 20px;">
                    <div class="single-shop-product">
                        <div class="product-upper">
                            <a href="gucci.php"><img src="img/gucci.jpg" style="height: 170px; width: 200"></a>
                            <h2 style="margin-left: 80px">Gucci</h2>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3 col-sm-6" style="margin-bottom:  90px; margin-top: 20px;">
                    <div class="single-shop-product">
                        <div class="product-upper">
                            <a href="armani.php"><img src="img/armani.png" style="height: 170px; width: 200"></a>
                            <h2 style="margin-left: 80px">Armani</h2>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3 col-sm-6" style="margin-bottom:  90px; margin-top: 20px;">
                    <div class="single-shop-product">
                        <div class="product-upper">
                            <a href="prada.php"><img src="img/prada.jpg" style="height: 170px; width: 200"></a>
                            <h2 style="margin-left: 80px">Prada</h2>
                        </div>
                    </div>
                </div>
